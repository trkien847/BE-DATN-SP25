...
// Route::prefix('admin')->name('admin.')->middleware(['auth', 'admin'])->group(function () {
  ...
  // Quản lý người dùng
  Route::get('/users', [UserManagementController::class, 'index'])->name('admin.users.list');
  ...
  Route::get('/roles/create', [UserManagementController::class, 'rolesCreate'])->name('admin.roles.create');
  Route::post('/roles/store', [UserManagementController::class, 'rolesStore'])->name('admin.roles.store');
  Route::get('/roles/{id}/edit', [UserManagementController::class, 'rolesEdit'])->name('admin.roles.edit');
  Route::put('/roles/{id}', [UserManagementController::class, 'rolesUpdate'])->name('admin.roles.update');
  Route::delete('/roles/{id}', [UserManagementController::class, 'rolesDestroy'])->name('admin.roles.destroy');
// });