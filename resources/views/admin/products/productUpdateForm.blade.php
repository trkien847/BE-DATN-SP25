...
<form action="{{ route('products.update', $product->id) }}" method="post" enctype="multipart/form-data" style="margin-top: 10px;">
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-3">
            ...
            <input type="number" class="form-control" id="productSalePrice" name="sale_price" value="{{$product->sale_price}}">
        </div>
        ...
        <div class="col-md-6 mb-3">
            ...
            <input type="datetime-local" id="timestampInput" name="sale_price_end_at" class="form-control" value="{{$product->sale_price_end_at}}">
        </div>
